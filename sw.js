const CACHE_NAME = 'pilgrimage-route-nav-v70-wonju-route-cleanup-20260710';
const CORE_ASSETS = [
  './',
  './index.html',
  './manifest.json',
  './css/route-nav.css?v=20260710-v70-wonju-route-cleanup',
  './js/route-nav.js?v=20260710-v70-wonju-route-cleanup',
  './routes/sacred-site-landmarks.js?v=20260710-v70-wonju-route-cleanup',
  './routes/hanti-route-data-v1.js?v=20260710-v70-wonju-route-cleanup',
  './routes/seoul-pilgrimage-routes.js?v=20260710-v70-wonju-route-cleanup',
  './routes/nimui-gil-routes.js?v=20260710-v70-wonju-route-cleanup',
  './routes/jeonju-pilgrimage-routes.js?v=20260710-v70-wonju-route-cleanup',
  './routes/test-route-data-v1.js?v=20260710-v70-wonju-route-cleanup',
