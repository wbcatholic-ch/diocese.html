const CACHE_NAME = 'pilgrimage-route-nav-v76-route-labels-jeonju-fix-20260711';
const CORE_ASSETS = [
  './',
  './index.html',
  './manifest.json',
  './css/route-nav.css?v=20260711-v76-route-labels-jeonju-fix',
  './js/route-nav.js?v=20260711-v76-route-labels-jeonju-fix',
  './routes/sacred-site-landmarks.js?v=20260711-v76-route-labels-jeonju-fix',
  './routes/hanti-route-data-v1.js?v=20260711-v76-route-labels-jeonju-fix',
  './routes/seoul-pilgrimage-routes.js?v=20260711-v76-route-labels-jeonju-fix',
  './routes/nimui-gil-routes.js?v=20260711-v76-route-labels-jeonju-fix',
  './routes/jeonju-pilgrimage-routes.js?v=20260711-v76-route-labels-jeonju-fix',
  './routes/test-route-data-v1.js?v=20260711-v76-route-labels-jeonju-fix',
