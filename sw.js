const CACHE_NAME = 'pilgrimage-route-nav-v73-navigation-state-fix-20260710';
const CORE_ASSETS = [
  './',
  './index.html',
  './manifest.json',
  './css/route-nav.css?v=20260710-v73-navigation-state-fix',
  './js/route-nav.js?v=20260710-v73-navigation-state-fix',
  './routes/sacred-site-landmarks.js?v=20260710-v73-navigation-state-fix',
  './routes/hanti-route-data-v1.js?v=20260710-v73-navigation-state-fix',
  './routes/seoul-pilgrimage-routes.js?v=20260710-v73-navigation-state-fix',
  './routes/nimui-gil-routes.js?v=20260710-v73-navigation-state-fix',
  './routes/jeonju-pilgrimage-routes.js?v=20260710-v73-navigation-state-fix',
  './routes/test-route-data-v1.js?v=20260710-v73-navigation-state-fix',
