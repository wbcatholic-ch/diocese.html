const CACHE_NAME = 'pilgrimage-route-nav-v75-section-colors-distance-20260711';
const CORE_ASSETS = [
  './',
  './index.html',
  './manifest.json',
  './css/route-nav.css?v=20260711-v75-section-colors-distance',
  './js/route-nav.js?v=20260711-v75-section-colors-distance',
  './routes/sacred-site-landmarks.js?v=20260711-v75-section-colors-distance',
  './routes/hanti-route-data-v1.js?v=20260711-v75-section-colors-distance',
  './routes/seoul-pilgrimage-routes.js?v=20260711-v75-section-colors-distance',
  './routes/nimui-gil-routes.js?v=20260711-v75-section-colors-distance',
  './routes/jeonju-pilgrimage-routes.js?v=20260711-v75-section-colors-distance',
  './routes/test-route-data-v1.js?v=20260711-v75-section-colors-distance',
