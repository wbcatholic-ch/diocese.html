const CACHE_NAME = 'pilgrimage-route-nav-v78-hanti-connected-all-route-names-20260711';
const CORE_ASSETS = [
  './',
  './index.html',
  './manifest.json',
  './css/route-nav.css?v=20260711-v78-hanti-connected-all-route-names',
  './js/route-nav.js?v=20260711-v78-hanti-connected-all-route-names',
  './routes/sacred-site-landmarks.js?v=20260711-v78-hanti-connected-all-route-names',
  './routes/hanti-route-data-v1.js?v=20260711-v78-hanti-connected-all-route-names',
  './routes/seoul-pilgrimage-routes.js?v=20260711-v78-hanti-connected-all-route-names',
  './routes/nimui-gil-routes.js?v=20260711-v78-hanti-connected-all-route-names',
  './routes/jeonju-pilgrimage-routes.js?v=20260711-v78-hanti-connected-all-route-names',
  './routes/test-route-data-v1.js?v=20260711-v78-hanti-connected-all-route-names',
