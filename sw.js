const CACHE_NAME = 'pilgrimage-route-nav-v72-nimui-2-2-gpx-replace-20260710';
const CORE_ASSETS = [
  './',
  './index.html',
  './manifest.json',
  './css/route-nav.css?v=20260710-v72-nimui-2-2-gpx-replace',
  './js/route-nav.js?v=20260710-v72-nimui-2-2-gpx-replace',
  './routes/sacred-site-landmarks.js?v=20260710-v72-nimui-2-2-gpx-replace',
  './routes/hanti-route-data-v1.js?v=20260710-v72-nimui-2-2-gpx-replace',
  './routes/seoul-pilgrimage-routes.js?v=20260710-v72-nimui-2-2-gpx-replace',
  './routes/nimui-gil-routes.js?v=20260710-v72-nimui-2-2-gpx-replace',
  './routes/jeonju-pilgrimage-routes.js?v=20260710-v72-nimui-2-2-gpx-replace',
  './routes/test-route-data-v1.js?v=20260710-v72-nimui-2-2-gpx-replace',
